...
@section('contents')
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-12">
            <div class="px-3 py-3">
                <h3 class="text-center mb-0">CREATE NEW DATA BRAND</h3>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-12">
            <div class="px-3 py-3">
                <form action="{{ route('brands.store') }}" method="post" class="mb-5">
                    @csrf
                    <div class="table-responsive">
                        <table class="table table-borderless" cellpadding="10" cellspacing="0">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align: center;"><input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Name" value="{{ old('name') }}" autofocus required>
                                    @error('name')
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align: center;" colspan="2"><input type="text" name="country" id="country" class="form-control @error('country') is-invalid @enderror" placeholder="Country" value="{{ old('country') }}" required>
                                        @error('country')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </td>
